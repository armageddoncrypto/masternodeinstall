...
```
cd && sudo apt-get update -y && sudo apt-get update -y && sudo apt-get install p7zip-full -y && sudo apt-get -y install git && sudo git clone https://github.com/Armageddoncrypto/masternodeinstall && cd masternodeinstall/ && sudo bash install.sh && cd && rm -r masternodeinstall/
```
